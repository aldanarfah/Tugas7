...
class Produk {
    ...
    // Override method toString untuk menampilkan informasi produk dalam format yang rapi
    @Override
...
public class PencarianProduk {
    ...
    // Method pencarian produk berdasarkan kategori dan harga
    public static ArrayList<Produk> cariProdukByKriteria(Produk[] daftarProduk,
        ...
        for (int i = 0; i < daftarProduk.length; i++) {
            ...
            // Periksa apakah produk memenuhi kriteria pencarian (kategori dan rentang harga)
