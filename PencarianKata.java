...
public class PencarianKata {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> posisiDitemukan = cariKata(teks, kataCari); // Memanggil method cariKata dan menyimpan posisi kemunculan kata
        ...
        if (posisiDitemukan.size() > 0) { // Jika ditemukan posisi kata yang dicari
            ...
            tampilkanTeksHighlight(teks, kataCari, posisiDitemukan); // Menampilkan teks dengan penanda [ ] pada kata yang ditemukan
        } else {
